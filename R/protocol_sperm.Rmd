...
- microscope and camera set up for sample inspection and photographing (see details[Microscope, camera, software specifications])
...
2. further processing methods:
    ...
    - **Flushing** (useful, if the vas deferens is large enough for cannulation):  
        ...
        iii. prepare a slide as indicated below[Preparing slides] and store the rest in 5% formalin  
    - **Float-out**:  
...
#### Testes #### 
0. ❗not the best method as immature sperm might be present because the sperm matures in epididymis -  a cordlike structure along the top of each testicle
...
4. cut the other testis in half longitudinally, remove a small piece from the middle - mush-like tissue (1mm x 1mm), mix with 200µl PBS and pipette on the microscope slide (see below[Preparing slides]), store the rest in 5% formalin 
...
1. prepare stains:
    i. add 74.41 µl DMSO **Kim will add details** to 50 µg of desiccated (-20 °C) Mitotracker Green FM (Invitrogen M7514), resuspend
    ii. to 1 ml of water, add 10 µl of Hoechst 33342 fluorescent dye and 1 µl of the above solution, mix well
...
- if sacrificing birds, take testes and vas deference and use those to prepare fresh microscope slides (see here [Testes] and here[Vas deferens]) and store the rest for later in 5% formalin
