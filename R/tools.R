...
# load/install packages
    packages = c('data.table', 'ggplot2', 'ggthemes', 'glue','grid', 'htmlTable', 'lattice', 'lubridate', 'magrittr', 'maptools', 'plyr','raster','RColorBrewer','readxl','scales','stringr','zoo','writexl')
