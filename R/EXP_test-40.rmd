...
# Correlations between Kim, Martin & Maggie
```{r Cor,  warning = FALSE, message = FALSE, fig.align="center", fig.width=6.5, fig.height=8}
...
# Repeatability of the three measurements (Kim's, Martin's & Maggie's)
```{r Rall,  warning = FALSE, message = FALSE, fig.align="center", fig.width=8, fig.height=2}
    ...
    g1 = 
        ggplot(xy, aes(x = part, y = pred, col = method_CI)) +
          ...
          ylim(c(min(xy$lwr),max(xy$upr)))+
          scale_y_continuous(breaks = seq(min(xy$lwr), 99, length.out=6))+
          coord_flip()+
          theme_bw() +
...
# Repeatability of Kim & Martin
```{r R_KTMB,  warning = FALSE, message = FALSE, fig.align="center", fig.width=8, fig.height=2}

    g1 = 
        ggplot(xyKTMB, aes(x = part, y = pred, col = method_CI)) +
          geom_errorbar(aes(ymin = lwr, ymax = upr, col = method_CI), width = 0.1, position = position_dodge(width = 0.25) ) +
          #ggtitle ("Sim based")+
          geom_point(position = position_dodge(width = 0.25)) +
          scale_color_viridis(discrete=TRUE, begin=0, end = 0.5)  +
          ...
          geom_hline(yintercept = 99, col = 'red')+
          labs(x = NULL, y = "Repeatability [%]")+
          ylim(c(min(xyKTMB$lwr),max(xyKTMB$upr)))+
          scale_y_continuous(breaks = (seq(min(xyKTMB$lwr), 99, length.out=6)))+
          coord_flip()+
          theme_bw() +
          theme(plot.title = element_text(size=9),
            legend.position = "none")
    ...
    g2 = 
        ggplot(xy2KTMB, aes(x = part, y = pred, col = method_CI)) +
          geom_errorbar(aes(ymin = lwr, ymax = upr, col = method_CI), width = 0.1, position = position_dodge(width = 0.25) ) +
          #ggtitle ("Sim based")+
          geom_point(position = position_dodge(width = 0.25)) +
          scale_color_viridis(discrete=TRUE, begin=0, end = 0.5)  +
          scale_fill_viridis(discrete=TRUE, begin=0, end = 0.5) + 
          labs(x = NULL, y = "Repeatability [%]")+
          ylim(c(min(xy2KTMB$lwr),max(xy2KTMB$upr)))+
          coord_flip()+
          theme_bw() +
          theme(plot.title = element_text(size=9))
...
```{r R_KTMB_T,  echo = FALSE, message = FALSE}
rbind(xyKTMB,xy2KTMB)[,1:4]
```

# Repeatability of Kim & Maggie
```{r R_KTMC,  warning = FALSE, message = FALSE, fig.align="center", fig.width=8, fig.height=2}

    g1 = 
        ggplot(xyKTMC, aes(x = part, y = pred, col = method_CI)) +
          geom_errorbar(aes(ymin = lwr, ymax = upr, col = method_CI), width = 0.1, position = position_dodge(width = 0.25) ) +
          #ggtitle ("Sim based")+
          geom_point(position = position_dodge(width = 0.25)) +
          scale_color_viridis(discrete=TRUE, begin=0, end = 0.5)  +
          ...
          geom_hline(yintercept = 99, col = 'red')+
          labs(x = NULL, y = "Repeatability [%]")+
          ylim(c(min(xyKTMC$lwr),max(xyKTMC$upr)))+
          scale_y_continuous(breaks = seq(min(xyKTMC$lwr), 99, length.out=6))+
          coord_flip()+
          theme_bw() +
          theme(plot.title = element_text(size=9),
            legend.position = "none")
    ...
    g2 = 
        ggplot(xy2KTMC, aes(x = part, y = pred, col = method_CI)) +
          geom_errorbar(aes(ymin = lwr, ymax = upr, col = method_CI), width = 0.1, position = position_dodge(width = 0.25) ) +
          #ggtitle ("Sim based")+
          geom_point(position = position_dodge(width = 0.25)) +
          scale_color_viridis(discrete=TRUE, begin=0, end = 0.5)  +
          scale_fill_viridis(discrete=TRUE, begin=0, end = 0.5) + 
          labs(x = NULL, y = "Repeatability [%]")+
          ylim(c(min(xy2KTMC$lwr),max(xy2KTMC$upr)))+
          coord_flip()+
          theme_bw() +
          theme(plot.title = element_text(size=9))
...
```{r R_KTMC_T,  echo = FALSE, message = FALSE}
rbind(xyKTMC,xy2KTMC)[,1:4]
```

# Repeatability of Martin & Maggie'
```{r R_MBMC,  warning = FALSE, message = FALSE, fig.align="center", fig.width=8, fig.height=2}

    g1 = 
        ggplot(xyMBMC, aes(x = part, y = pred, col = method_CI)) +
          geom_errorbar(aes(ymin = lwr, ymax = upr, col = method_CI), width = 0.1, position = position_dodge(width = 0.25) ) +
          #ggtitle ("Sim based")+
          geom_point(position = position_dodge(width = 0.25)) +
          scale_color_viridis(discrete=TRUE, begin=0, end = 0.5)  +
          ...
          geom_hline(yintercept = 99, col = 'red')+
          labs(x = NULL, y = "Repeatability [%]")+
          ylim(c(min(xyMBMC$lwr),max(xyMBMC$upr)))+
          scale_y_continuous(breaks = seq(min(xyMBMC$lwr), 99, length.out=6))+
          coord_flip()+
          theme_bw() +
          theme(plot.title = element_text(size=9),
            legend.position = "none")
    ...
    g2 = 
        ggplot(xy2MBMC, aes(x = part, y = pred, col = method_CI)) +
          geom_errorbar(aes(ymin = lwr, ymax = upr, col = method_CI), width = 0.1, position = position_dodge(width = 0.25) ) +
          #ggtitle ("Sim based")+
          geom_point(position = position_dodge(width = 0.25)) +
          scale_color_viridis(discrete=TRUE, begin=0, end = 0.5)  +
          scale_fill_viridis(discrete=TRUE, begin=0, end = 0.5) + 
          labs(x = NULL, y = "Repeatability [%]")+
          ylim(c(min(xy2MBMC$lwr),max(xy2MBMC$upr)))+
          coord_flip()+
          theme_bw() +
          theme(plot.title = element_text(size=9))
...
```{r R_MBMC_T,  echo = FALSE, message = FALSE}
rbind(xyMBMC,xy2MBMC)[,1:4]
```

# TEST
```{r test,  warning = FALSE, message = FALSE, fig.align="center", fig.width=8, fig.height=2}
...
ggplot(xy_, aes(x = part, y = pred, col = comparison, shape = method_CI)) +
          ...
          geom_text(y =99, x =0.5, label = '99', col = 'red', size = 3)+
          coord_flip()+
          theme_bw() +
...
# TEST2
```{r test2,  warning = FALSE, message = FALSE, fig.align="center", fig.width=4, fig.height=4}

g1 =
ggplot(xy_, aes(x = part, y = pred, col = comparison, shape = method_CI)) +
          geom_errorbar(aes(ymin = lwr, ymax = upr, col = comparison), width = 0.1, position = position_dodge(width = 0.8) ) +
          #ggtitle ("Sim based")+
