...
# merge datasets
    n1 = data.table(read_excel(here::here("Data/Ruffs2020_inbreeding.xlsx"), sheet = "allBins", na = "NA"))
    n1 = n1[Sex == 1]
    ...
    n2 = data.table(read_excel(here::here("Data/RuffsCK_2010-2019_RunData6.xlsx"), sheet = "allAlleles", na = "NA", col_type = 'text'))
    n2 = n2[sex == 1]
